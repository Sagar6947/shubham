...
if (isset($_POST["sell_property"])) {
  ...
  $youtube = preg_replace("#.*youtube\.com/watch\?v=#", "" , $youtube);
    ...
    `landmarks`, `ownership`, `amenities`, `liabilities`, `terms` , `youtube`, `price_cr`, `price_val`) VALUES ('$agent','$user_id','$property_name','$registration_no',  '$property_category' ,'$property_type', 
