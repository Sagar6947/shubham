            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Main Category</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="add-main-category.php" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white"><i class="fa fa-plus-circle"></i> Add Main Category</a>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="edit-main-category.php?id=<?= base64_encode($ro['cid']) ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                                            </td>
                                            <td><a href="delete.php?id=<?= $ro['cid']; ?>&&tag=main_category"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
