...
if (isset($_POST["submit"])) {
    ...
    move_uploaded_file($tmpfile, 'images/client/' . $folder);



    $rt = "INSERT INTO `tbl_client`( `title`, `image`)  VALUES ( '" . $title . "','" . $folder . "' )";
    $result = mysqli_query($con, $rt);

    if ($result) {
        $msg = '<div class="alert alert-success" role="alert">
 Clinets Added Successfully</div>';
    } else {
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="tb-fname">Client Name</label>
                                            </div>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td><?= $ro['title'] ?></td>
                                            <td><img src="images/client/<?= $ro['image'] ?>" style="height:80px"></td>
                                            <td><a href="delete.php?id=<?= $ro['id'] ?>&&tag=client"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
