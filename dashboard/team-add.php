...
if (isset($_POST["submit"])) {
    ...
    $rt = "INSERT INTO `tbl_team`(`image`, `name`, `phone`, `email`, `designation`, `description`) VALUES ('" . $folder . "','" . $name . "','" . $phone . "' , '" . $email . "', '" . $designation . "', '" . $descr . "')";
    $result = mysqli_query($con, $rt);

    if ($result) {
        $msg = '<div class="alert alert-success" role="alert">
           Team Added Successfully</div>';
    } else {
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="tb-fname" placeholder="Enter Title here" name="name" required>
