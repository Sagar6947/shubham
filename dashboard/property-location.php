...
if (isset($_POST["submit"])) {
    ...
    $rt = "INSERT INTO `tbl_areas`(`area`) VALUES ('$name')";
    $result = mysqli_query($con, $rt);
    if ($result) {
        $msg = '<div class="alert alert-success" role="alert">Location Added Successfully</div>';
    } else {
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Location</h4>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td><?= $ro['area'] ?></td>
                                            <td><a href="delete.php?id=<?= $ro['area_id'] ?>&&tag=location" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
