                                            ...
                                            <div class="submit-section">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <select class="form-control" name="ba_id">

                                                            <option value="">Select Realtor</option>
                                                            <?php
                                                            $realtor = mysqli_query($con, "SELECT * FROM `tbl_agent`  ");
                                                            while ($agent = mysqli_fetch_array($realtor)) {
                                                            ?>
                                                                  <option value="<?= $agent['agent_id'] ?>" <?= (($agent['agent_id'] == $list['ba_id']) ? 'selected' : '') ?>><?= $agent['agent_name'] ?>(<?= $agent['agent_phone'] ?>)</option>
                                                            <?php
                                                            }
                                                            ?>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        ...
                                                                        <div class="image">
                                                                            ...
                                                                            <img src="../agent-dashboard/images/property/<?= $img['image'] ?>" alt="latest property" class="img-fluid imgheight">
