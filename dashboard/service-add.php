...
if (isset($_POST["submit"])) {
    ...
    $rt = "INSERT INTO `tbl_service`(`title`, `image`, `description`) VALUES ( '" . $title . "','" . $folder . "','" . $descr . "')";
    $result = mysqli_query($con, $rt);

    if ($result) {
        $msg = '<div class="alert alert-success" role="alert">
 Services Added Successfully</div>';
    } else {
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Services Add</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="service.php" type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white">Services list</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" id="tb-fname" placeholder="Enter Title here" name="title">
