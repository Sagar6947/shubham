                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-row">
                                        <div class="">
                                            <img src="../agent-dashboard/images/property/<?= $img['image']  ?>" alt="<?= $property['property_name'] ?>" class="img-circle" height="100" width="100" />

                                        </div>
                                        <div class="p-l-20">
                                            <h4 class="font-light"><?= wordwrap($property['property_name'], 30, '<br>') ?></h4>
                                            <h6>
