...
// print_R($_POST['amenities']);
    $amenities = (($_POST['amenities'] != '')? implode(",", $_POST['amenities']):'');

    $price_cr = strip_tags($_POST['price_cr']);
    $price_val = strip_tags($_POST['price_val']);

    // $video_type = strip_tags($_POST['video_type']);
    ...
    $rt = "INSERT INTO `tbl_property_sell`(`ba_id`, `user_id`, `property_name`, `registration_no`, `property_category`, `property_type`, `flat_bhk`, `property_price`, `address`, 
    `state`, `city`, `zipcode`, `area`, `map`, `plot_area`, `builtup_area`, `built_year`, `bedrooms`, `bathrooms`, `total_floor`, `facing`, `furnished`, `transaction_type`, 
    `landmarks`, `ownership`, `amenities`, `liabilities`, `terms` , `youtube`, `price_cr`, `price_val`) VALUES ('$ba_id','$user_id','$property_name','$registration_no',  '$property_category' ,'$property_type', 
    '$flat_bhk' ,'$property_price','$address','$state','$city','$zipcode','$area','$map', '$plot_area','$builtup_area','$built_year','$bedrooms','$bathrooms','$total_floor', 
    '$facing', '$furnished','$transaction_type','$landmarks','$ownership', '$amenities' ,'$liabilities', '$terms'   , '$youtube'  , '$price_cr'  , '$price_val')";
    $result = mysqli_query($con, $rt);
