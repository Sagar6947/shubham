...
<body>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg px-0">
                    <a class="navbar-brand" href="index.php">
                        <img src="img2/logo.png" alt="HomeID" class="d-none d-lg-inline-block" style="height: 70px;">
                        <!-- <img src="img2/logo-white.png" alt="HomeID" class="d-inline-block d-lg-none"> -->
                    </a>
                    ...
                    <div class="collapse navbar-collapse mt-3 mt-lg-0 mx-auto flex-grow-0" id="primaryMenu01">
                        <ul class="navbar-nav hover-menu main-menu px-0 mx-lg-n4">
                            <!-- <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false"
                                class="nav-item dropdown navbtn">
                                <a class="nav-link p-0" href="#forhunting">
                                    House Hunting
                            ...
                            <li id="navbar-item-property" aria-haspopup="true" aria-expanded="false"
                                ...
                                <a class="nav-link p-0" href="#forhome">
                                    E-Solutions For Homes
                                    <span class="caret"></span>
                                </a>
                            ...
                            <li id="navbar-item-dashboard" aria-haspopup="true" aria-expanded="false"
                                class="nav-item dropdown py-2 py-lg-5 px-0 px-lg-4">
                                <a class="nav-link p-0" href="#forothersector">
                                    E-Solutions For other Sectors
                                    <span class="caret"></span>
                                </a>

                            </li> -->

                            <li class="navbtn"><a href="home.php">House Hunting</a></li>
                            <li class="navbtn"><a href="esolutions-for-home.php">E-Solutions For Homes</a></li>
                            <li class="navbtn"><a href="#forothersector"> E-Solutions For other Sectors</a></li>
    ...
    <main id="content">
        <section>
            <div id="househunting" class="slick-slider mx-0 custom-arrow-center" data-slick-options='{"slidesToShow": 1, "autoplay":true,"responsive":[{"breakpoint": 1200,"settings": {"slidesToShow":1,"arrows":false,"dots":false}},{"breakpoint": 992,"settings": {"slidesToShow":1,"arrows":false,"dots":false}},{"breakpoint": 768,"settings": {"slidesToShow": 1,"arrows":false,"dots":false}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"arrows":false,"dots":false}}]}'>
                <div class="box px-0 d-flex flex-column" style="height: 70vh;">
                    <div class="bg-cover d-flex align-items-center custom-vh-02" style="background-image: url('images2/bg-slider-03.jpg')">
                        <div class="container">
                            <div class="row py-8" data-animate="zoomIn">

                                <div class="col-lg-7 col-md-6">
                                    <!-- <p
                                        class="text-white fs-22 font-weight-500 letter-spacing-367 text-uppercase mt-7 mb-4">
                                        For sale</p> -->
                                    <h2 class="lh-12 mb-4 text-white fs-md-60 fs-48 ">House Hunting <br> in Bhopal</h2>
                                    <!-- <p class="text-white fs-22 font-weight-500">070 Ruecker Knolls Suite 132</p>
                                    <p class="text-white fs-32 font-weight-600 lh-16">1.250.000</p> -->
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box px-0 d-flex flex-column" style="height: 70vh;">
                    <div class="bg-cover d-flex align-items-center custom-vh-02" style="background-image: url('img2/slider2.jpg')">
                        <div class="container">
                            <div class="row py-8" data-animate="zoomIn">
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <!-- <p
                                        class="text-white fs-22 font-weight-500 letter-spacing-367 text-uppercase mt-7 mb-4">
                                        For sale</p> -->
                                    <h2 class="lh-12 mb-4 text-white fs-md-60 fs-48">
                                        E-Solutions For Homes</h2>
                ...
                <div class="box px-0 d-flex flex-column" style="height: 70vh;">
                    <div class="bg-cover d-flex align-items-center custom-vh-02" style="background-image: url('img2/slider3.jpg')">
                        <div class="container">
                            <div class="row py-8" data-animate="zoomIn">
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <!-- <p
                                        class="text-white fs-22 font-weight-500 letter-spacing-367 text-uppercase mt-7 mb-4">
                                        For sale</p> -->
                                    <h2 class="lh-12 mb-4 text-white fs-md-60 fs-48">E-Solutions For <br> Other Sectors</h2>
                                    <!-- <p class="text-white fs-22 font-weight-500">070 Ruecker Knolls Suite 132</p>
                                    <p class="text-white fs-32 font-weight-600 lh-16">1.250.000</p> -->
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-6" data-animate="zoomIn">
                        <div class="card shadow-hover-1">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                <img src="img2/s2.jpg" alt="House Hunting">
                            </div>
                            <div class="card-body pt-3">
                                <h2 class="card-title fs-16 lh-2 mb-0"><a href="#" class="text-dark hover-primary redtxt">House Hunting</a></h2>
                                <p class="card-text font-weight-500 text-gray-light mb-2">We Can Help You Finding House / Flat / Shop / Land Area
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-6" data-animate="zoomIn">
                        <div class="card shadow-hover-1">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                <img src="img2/s3.jpg" alt="E-Solutions For Home">

                            </div>
                            <div class="card-body pt-3">
                                <h2 class="card-title fs-16 lh-2 mb-0"><a href="#" class="text-dark hover-primary redtxt">E-Solutions For Home</a></h2>
                                <p class="card-text font-weight-500 text-gray-light mb-2">E-Solutions For Your Home Like Bathroom Cleaning, Full House Cleaning etc.
                                </p>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-6" data-animate="zoomIn">
                        <div class="card shadow-hover-1">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                <img src="img2/s4.jpg" alt="E-Solutions For Other Sectors">

                            </div>
                            <div class="card-body pt-3">
                                <h2 class="card-title fs-16 lh-2 mb-0"><a href="#" class="text-dark hover-primary redtxt">E-Solutions For Other Sectors</a></h2>
                                <p class="card-text font-weight-500 text-gray-light mb-2">E-Solutions For Other Sectors Like Good Architect consultant, Housing & Personal Loan.
                                </p>
        ...
        <section id="forhunting" class="pt-lg-12 pb-lg-10 py-11" style="background: url(img2/bg2.webp);">
            <div class="container container-xxl">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="text-heading">House Hunting In Bhopal</h2>
                        <span class="heading-divider"></span>
                        <p class="mb-6">We Can Help You In Finding House / Flat / Land Area. We Can Help You In Sell Your House / Flat / Land Area. We Provide Rental House / Flat / Land Area.</p>
                    </div>
                    <div class="col-md-6 text-md-right">
                        <a href="#" class="btn fs-14 text-secondary btn-accent py-3 lh-15 px-7 mb-6 mb-lg-0 btn-orng">View all
                ...
                <div class="slick-slider slick-dots-mt-0 custom-arrow-spacing-30" data-slick-options='{"slidesToShow": 4, "autoplay":true,"dots":true,"responsive":[{"breakpoint": 1600,"settings": {"slidesToShow":3,"arrows":false}},{"breakpoint": 992,"settings": {"slidesToShow":2,"arrows":false}},{"breakpoint": 768,"settings": {"slidesToShow": 2,"arrows":false,"dots":true,"autoplay":true}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"arrows":false,"dots":true,"autoplay":true}}]}'>
                    <div class="box pb-7 pt-2">
                        <div class="card shadow-hover-2" data-animate="zoomIn">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                <img src="images2/properties-grid-02.jpg" alt="Home in Metric Way">
                            ...
                            <div class="card-body pt-3">
                                <h2 class="card-title fs-16 lh-2 mb-0"><a href="#" class="text-dark hover-primary ">Home in Metric Way</a></h2>
                                <p class="card-text font-weight-500 text-gray-light mb-2">BHOPAL
                                </p>
                    ...
                    <div class="box pb-7 pt-2">
                        <div class="card shadow-hover-2" data-animate="zoomIn">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                <img src="images2/properties-grid-01.jpg" alt="Affordable Urban House">
                                <div class="card-img-overlay p-2 d-flex flex-column">
                                    <div>
                                        <span class="badge mr-2 badge-primary">for Sale</span>
                                    </div>
                            ...
                            <div class="card-body pt-3">
                                <h2 class="card-title fs-16 lh-2 mb-0"><a href="#" class="text-dark hover-primary">Affordable Urban House</a></h2>
                                <p class="card-text font-weight-500 text-gray-light mb-2">BHOPAL
                                </p>
                                <ul class="list-inline d-flex mb-0 flex-wrap mr-n5">
                                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="3 Bedroom">
                    ...
                    <div class="box pb-7 pt-2">
                        <div class="card shadow-hover-2" data-animate="zoomIn">
                            ...
                            <div class="card-body pt-3">
                                <h2 class="card-title fs-16 lh-2 mb-0"><a href="#" class="text-dark hover-primary">Villa on Hollywood Boulevard</a></h2>
                                <p class="card-text font-weight-500 text-gray-light mb-2">BHOPAL
                                </p>
                                <ul class="list-inline d-flex mb-0 flex-wrap mr-n5">
                                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5" data-toggle="tooltip" title="3 Bedroom">
                    ...
                    <div class="box pb-7 pt-2">
                        <div class="card shadow-hover-2" data-animate="zoomIn">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                <img src="images2/properties-grid-04.jpg" alt="Home in Metric Way">
                                <div class="card-img-overlay p-2 d-flex flex-column">
                                    <div>
                                        <!-- <span class="badge mr-2 badge-orange">featured</span> -->
                                        <span class="badge mr-2 badge-primary">for Sale</span>
        ...
        <section class="pt-9 pb-8" style="background: url(img2/pattern-2.svg); background-size: cover;">
            <div class="container">
                ...
                <div class="row mt-7">
                    <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                        <div class="media rounded-lg bg-grey-3 px-4 h-100 align-items-center">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mb-6" data-animate="fadeInUp">
                        <div class="media rounded-lg bg-grey-3 px-4 h-100 align-items-center p17">
        ...
        <section id="forhome" class="bg-gray-02 pt-9 pb-lg-8" style="background: url(img2/bg2.webp);">
            <div class="container">
                ...
                <div class="slick-slider arrow-haft-inner mt-2 mx-0" data-slick-options='{"slidesToShow": 4, "autoplay":true,"dots":false,"responsive":[{"breakpoint": 1200,"settings": {"slidesToShow":3}},{"breakpoint": 992,"settings": {"slidesToShow":3}},{"breakpoint": 768,"settings": {"slidesToShow": 2,"arrows":false,"autoplay":true}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"arrows":false,"autoplay":true}}]}'>
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Bathroom Cleaning</h4>
                                <!-- <p class="card-text text-body px-lg-8">Sed ut perspiciatis unde omnis iste natus error
                                </p> -->
                            </div>
                        </div>
                    </div>
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Full House Cleaning</h4>
                    ...
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Car Cleaning at Your Door Step </h4>
                    ...
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Kitchen Cleaning</h4>
                    ...
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Sofa & Carpet Cleaning</h4>
                    ...
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Pest Control</h4>
                    ...
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Electrician</h4>
                    ...
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Plumber</h4>
                    ...
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">Carpenter</h4>
                    ...
                    <div class="box px-0 py-6" data-animate="fadeInUp">
                        <div class="card border-0 py-7 px-4 shadow-hover-3 bg-transparent bg-hover-white">
                            ...
                            <div class="card-body px-0 pt-5 pb-0 text-center">
                                <h4 class="card-title fs-16 lh-13 text-dark mb-2 px-10">White Wash / Wall Painting</h4>
        ...
        <section id="forothersector" style="background: url(img2/pattern-2.svg); background-size: cover;">
            <div class="container container-xxl">
                <div class="slick-slider" data-slick-options='{"slidesToShow": 1, "autoplay":true,"dots":false,"arrows":false}'>
                    <div class="bg-cover" style="background-image: url(images2/properties-slider-11.jpg)" data-animate="zoomIn">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 offset-lg-6 col-md-8 offset-md-4 py-11">
                                    <div class="bg-white rounded-lg position-relative z-index-2 pl-sm-13 pr-sm-10 py-sm-9 p-6">
                                        <h2 class="mt-2"><a href="#" class="text-heading hover-primary">E-Solution For Other Sectors</a></h2>
                                        <span class="heading-divider"></span>
                                        <!-- <p class="pt-2">Lorem ipsum dolor sit amet, consec tetur cing elit.</p> -->
                                        <ul class="list-unstyled row no-gutters mb-0">
                                            <li class="col-sm-12 mb-2"><i class="far fa-check mr-2 text-primary"></i>Good Architect Consultant
                                            </li>
                                            <li class="col-sm-12 mb-2"><i class="far fa-check mr-2 text-primary"></i>Housing & Personal Loan
                                            </li>
                                            <li class="col-sm-12 mb-2"><i class="far fa-check mr-2 text-primary"></i>Car Insurance, Health Insurance, Life Insurance.
                                            </li>
                                            <li class="col-sm-12 mb-2"><i class="far fa-check mr-2 text-primary"></i>Marriage Garden & Venue For Functions
                                            </li>
                                            <li class="col-sm-12 mb-2"><i class="far fa-check mr-2 text-primary"></i>Income Tax Consultant
                                            </li>
                                            <li class="col-sm-12 mb-2"><i class="far fa-check mr-2 text-primary"></i>Home Tution 5th to 12th (All Subjects)
                                            </li>
        ...
        <!-- <section class="pt-11 pb-13 bg-cover" style="background-image: url(img2/bg3.jpg)">
            <div class="container">
                <form class="text-center" data-animate="fadeInUp">
                    <h2 class="fs-34 font-weight-normal lh-141 mxw-740">
                        Subscribe to newsletter to receive exclusive offers and the latest news
                    </h2>
                    <div class="input-group input-group-lg mt-9 mxw-571">
    ...
    <footer class="pt-8 pb-6 footer text-gray-light" style="background: #040404;">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-5 mb-6 mb-md-0">
                    ...
                    <div class="lh-26 font-weight-500">
                        <p class="mb-0">Plot No.17 Shiva Royal Court 2nd Floor <br> Above Axis Bank Bawadiya kalan <br> Bhopal Madhya Pradesh</p>
                        <a class="d-block text-gray-light hover-primary" href="mailto: hereshubhamenterprises@gmail.com"> hereshubhamenterprises@gmail.com</a>
                        <a class="d-block text-gray-light font-weight-bold hover-primary fs-15" href="tel:+919522598949"> +91 9522598949 , +91 8871322950 , +91 7553503582</a>
                ...
                <!-- <div class="col-md-6 col-lg-2 mb-6 mb-md-0">
                    ...
                    <ul class="list-group list-group-flush list-group-no-border">
                        <li class="list-group-item bg-transparent p-0">
                            <a href="#" class="text-gray-light hover-primary lh-26 font-weight-500">Apartment for
                                Rent</a>
                        </li>
                        <li class="list-group-item bg-transparent p-0">
                            <a href="#" class="text-gray-light hover-primary lh-26 font-weight-500">Apartment Low to
                                hide</a>
                        </li>
                        <li class="list-group-item bg-transparent p-0">
                            <a href="#" class="text-gray-light hover-primary lh-26 font-weight-500">Offices for
                                Buy</a>
                        </li>
                        <li class="list-group-item bg-transparent p-0">
                            <a href="#" class="text-gray-light hover-primary lh-26 font-weight-500">Offices for
                ...
                <div class="col-md-6 col-lg-2 mb-6 mb-md-0">
                    <h4 class="text-heading fs-16 my-4 font-weight-500 redtxt">Quick links</h4>
                    <ul class="list-group list-group-flush list-group-no-border">
                        <li class="list-group-item bg-transparent p-0">
                            <a href="index.html" class="text-gray-light hover-primary lh-26 font-weight-500">Home</a>
                        </li>
                        <li class="list-group-item bg-transparent p-0">
                            <a href="home.php" class="text-gray-light hover-primary lh-26 font-weight-500">House Hunting
                            </a>
                        </li>
                        <li class="list-group-item bg-transparent p-0">
                ...
                <div class="col-md-6 col-lg-5 mb-6 mb-md-0">
                    <h4 class="text-heading fs-16 my-4 font-weight-500 redtxt">Sign Up for Our Newsletter</h4>
                    ...
                    <div class="row no-gutters mx-n2 icons">
                        <div class=" px-2 mb-4">
                            <a href="https://www.facebook.com/people/Shubham-Mishra/100081222413797/" class="btn btn-lg btn-block facebook text-white px-0">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                        </div>
                        <div class=" px-2 mb-4">
                            <a href="https://www.instagram.com/shubhamenterpriseshere/?igshid=YmMyMTA2M2Y%3D" class="btn btn-lg btn-block text-white px-0">
                                <i class="fab fa-instagram"></i>
                            </a>
                        </div>
                        <div class=" px-2 mb-4">
                            <a href="https://twitter.com/Shubhamenterprl?t=85p-aiaoZO6dyhtD3UCQgQ&s=08" class="btn btn-lg btn-block twitter text-white px-0">
                                <i class="fab fa-twitter"></i>
                            </a>
                        </div>
                        <div class=" px-2 mb-4">
                            <a href="https://www.youtube.com/channel/UCXeMEL3p4A6P4YZlSm6Iz3Q" class="btn btn-lg btn-block twitter text-white px-0">
            ...
            <div class="mt-0 mt-md-10 row">
                ...
                <p class="col-md-auto mt-4 mt-md-0 text-center">
                    © 2022 Shubham Enterprises. All Rights Reserved
                </p>
            </div>
        </div>
    </footer>
                            ...
                            <form class="form">
                                ...
                                <div class="d-flex p-2 border re-capchar align-items-center mb-4">
                                    ...
                                    <a href="#" class="d-inline-block ml-auto">
                                        <img src="images2/re-captcha.png" alt="Re-capcha">
                                    </a>
                                </div>
                            ...
                            <div class="row no-gutters mx-n2">
                                ...
                                <div class="col-4 px-2 mb-4">
                                    <a href="#" class="btn btn-lg btn-block google px-0">
                                        <img src="images2/google.png" alt="Google">
                                    </a>
                                </div>
                                <div class="col-4 px-2 mb-4">
